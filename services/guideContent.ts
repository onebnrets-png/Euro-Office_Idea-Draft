...
var GUIDE_EN: Record<string, StepGuide> = {
  ...
  generalObjectives: {
    ...
    stepIntro: 'General objectives define the broad, long-term goals that your project contributes to. These go beyond the project itself — they represent the wider change you aim to support. Content will be expanded in the next session.',
    fields: {
      objective: {
        whatIsThis: 'A general objective is a broad, strategic goal that extends beyond the project\'s direct scope and timeline.',
        whyImportant: 'General objectives connect your project to wider EU and societal goals, demonstrating its broader significance.',
        whatToWrite: 'Define 2-3 broad objectives that your project contributes to (not achieves alone). These should align with EU strategies.',
        tips: 'Use verbs like "contribute to," "support," "advance." These are NOT directly measurable within the project timeline.',
        euContext: 'Evaluators check whether general objectives align with EU call priorities and broader policy goals.',
        example: 'Example: "To contribute to reducing the digital skills gap between urban and rural areas in Southeast Europe, in alignment with the European Digital Decade targets for 2030."',
      },
    },
  },
  ...
  specificObjectives: {
    ...
    stepIntro: 'Specific objectives are concrete, measurable targets that your project will directly achieve during its lifetime. They must be SMART. Content will be expanded in the next session.',
    fields: {
      objective: {
        whatIsThis: 'A specific objective is a concrete, measurable target directly achievable within the project timeframe.',
        whyImportant: 'Specific objectives define what your project will measurably achieve. They drive your activities and results.',
        whatToWrite: 'Define 3-5 SMART objectives (Specific, Measurable, Achievable, Relevant, Time-bound).',
        tips: 'Each specific objective should link to at least one work package. Include quantified targets.',
        euContext: 'Evaluators assess whether specific objectives are realistic, measurable, and sufficient to achieve the main aim.',
        example: 'Example: "To train and certify 2,000 rural educators in digital competence levels B1-B2 (DigComp 2.2) across 5 countries within 30 months of project start."',
      },
    },
  },
